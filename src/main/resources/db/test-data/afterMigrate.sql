...
-- Inserindo dados na tabela grupo-permissao
...
-- Inserindo dados na tabela restaurante_usuario_responsavel
...
values (1, '076ea6b7-4afa-4b3c-9504-3af97b0d1e76', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801',
        'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id,
                    ...
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'f473710c-7582-4a94-afdc-c52c7fc3e907', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
